...
void Pin_Init(ubyte1 group_idx, ubyte1 pin_idx, ubyte1 pin_value)
{
    ...
    // PVG принимает значение в формате "проценты * 100" (1000 .. 9000)

    ubyte2 pvg_set_value = (ubyte2) (pin_value * 100U);
    ...
    case PIN_MODE_DI:
        IO_DI_Init(g_pin_configs[internal_numb_pin].di_cfg.pin_channel,
                   g_pin_configs[internal_numb_pin].di_cfg.pull_resistor,
                   g_pin_configs[internal_numb_pin].di_cfg.voltage_limits);
    ...
    case PIN_MODE_ADC:
        IO_ADC_ChannelInit(
                ...
                g_pin_configs[internal_numb_pin].adc_cfg.pull_resistor,
    ...
    case PIN_MODE_PWD:
        ...
        IO_PWD_ComplexInit(
                ...
                g_pin_configs[internal_numb_pin].pwd_complex_cfg.pull_resistor,
