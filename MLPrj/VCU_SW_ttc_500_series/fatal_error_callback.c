...
/* Output and update for Simulink Function: '<Root>/fatal_error_callback' */
void fatal_error_callback(ubyte1 rtu_diag_state, ubyte1 rtu_watchdog_state,
