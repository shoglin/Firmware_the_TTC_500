...
void VCU_SW_step(void)
{
  ...
  static ubyte1 oldDiType;

  /* S-Function (digitalInputGet_ttc500): '<S7>/EngineAirFilterClogSens' */

  /* FunctionCaller: '<S7>/Function Caller13' */
  convDIOSttToEnum(rtb_di_104_value, rtb_di_104_error, &rtb_FunctionCaller13);

  /* DataTypeConversion: '<S7>/Data Type Conversion' incorporates:
   *  DataStoreWrite: '<S7>/Data Store Write13'
   */
  VCU_SW_DW.OutputNetworkData.Pin101_Pin104_FB.Pin0_feedback = (ubyte2)
  ...
  VCU_SW_B.DataStoreRead =
    VCU_SW_DW.OutputNetworkData.Pin101_Pin104_FB.Pin0_feedback;

  /* S-Function (scanpack): '<S2>/CANPack_VLVCMD_HYD1' */
  /* S-Function (scanpack): '<S2>/CANPack_VLVCMD_HYD1' */
  VCU_SW_B.CANPack_VLVCMD_HYD1.ID = 419364903U;
        ...
        {
          {
            VCU_SW_B.CANPack_VLVCMD_HYD1.Data[0] =
              VCU_SW_B.CANPack_VLVCMD_HYD1.Data[0] | (ubyte1)((ubyte2)
              (packedValue & (ubyte2)0xFFU));
            VCU_SW_B.CANPack_VLVCMD_HYD1.Data[1] =
              VCU_SW_B.CANPack_VLVCMD_HYD1.Data[1] | (ubyte1)((ubyte2)((ubyte2)
 ...
 if (VCU_SW_B.CANUnpack_Pin101_Pin104_CMD_o1 == 1)
